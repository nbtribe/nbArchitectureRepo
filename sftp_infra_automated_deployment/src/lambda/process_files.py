...
def check_required_files():
    ...
    for file in required_files_list:
        if file not in files:
            print("All files not present")
            return False

    return True

def update_copy_script():
    template_key = f'{customer.lower()}_{source_sys}_copy_statement_template.sql'
    ...
    try:
        ...
        new_file_key= f"{scripts_folder}{customer}_{source_sys}_copy_statement.sql"
