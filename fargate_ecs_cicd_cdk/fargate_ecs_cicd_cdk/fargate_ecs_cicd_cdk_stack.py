...
class FargateEcsCicdCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # create policy to add to exec role
        ...
        # add policy to exec role
        task_role.add_managed_policy(task_policy)
        ...
        project = codebuild.Project(
            ...
            environment_variables={
                ...
                "ecr_repo_name" : codebuild.BuildEnvironmentVariable(value=ecrRepo.repository_name),
